...
* Bump dependabot/fetch-metadata from 2.3.0 to 2.4.0 by @dependabot[bot] in https://github.com/codedor/filament-redirects/pull/23
* Bump aglipanci/laravel-pint-action from 2.5 to 2.6 by @dependabot[bot] in https://github.com/codedor/filament-redirects/pull/26
* Bump stefanzweifel/git-auto-commit-action from 5 to 7 by @dependabot[bot] in https://github.com/codedor/filament-redirects/pull/29
* Bump actions/checkout from 4 to 5 by @dependabot[bot] in https://github.com/codedor/filament-redirects/pull/28
* BRU001-105 Ignore trailing slash at the end by @jyrkidn in https://github.com/codedor/filament-redirects/pull/27
* Translate static text and add Dutch translations by @jyrkidn in https://github.com/codedor/filament-redirects/pull/22

**Full Changelog**: https://github.com/codedor/filament-redirects/compare/v1.3.0...v1.4.0
